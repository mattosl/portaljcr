...
public class Attachment  implements java.io.Serializable {
    ...
    private com.totvs.technology.ecm.dm.ws.Attachment fileSelected;
    ...
    public Attachment(
           ...
           com.totvs.technology.ecm.dm.ws.Attachment fileSelected,
           long fileSize,
           byte[] filecontent,
     ...
     * @return fileSelected
     */
    public com.totvs.technology.ecm.dm.ws.Attachment getFileSelected() {
        return fileSelected;
    }
     ...
     * @param fileSelected
     */
    public void setFileSelected(com.totvs.technology.ecm.dm.ws.Attachment fileSelected) {
        this.fileSelected = fileSelected;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.dm.ecm.technology.totvs.com/", "attachment"));
